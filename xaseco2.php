...
define('MP_BUILD', '2013-02-27-16_00');
...
class Aseco {
	...
	var $op_abilities;
	var $bannedips;
	var $startup_phase;  // XAseco2 start-up phase
	...
	var $prevsecond;
	var $uptime;  // XAseco2 start-up time
	...
	function Aseco($debug) {
		...
		echo '# initialize XASECO2 ###########################################################' . CRLF;

		// log php & mysql version info
		$this->console_text('[XAseco2] PHP Version is ' . phpversion() . ' on ' . PHP_OS);
	...
	/**
	 * Authenticates XASECO2 at the server.
	 */
	function connect() {
...
// create an instance of XASECO2 and run it
