...
Aseco::addChatCommand('shutdown', 'Shuts down XASECO2', true);
Aseco::addChatCommand('shutdownall', 'Shuts down Server & XASECO2', true);
...
//					else
	 ...
	 */
		...
		trigger_error('Shutdown XASECO2!', E_USER_ERROR);

	/**
	 * Shuts down Server & XASECO2.
	 */
		...
		if (!$rtn) {
			...
			trigger_error('Shutdown ' . $aseco->server->getGame() . ' server & XASECO2!', E_USER_ERROR);
		}
