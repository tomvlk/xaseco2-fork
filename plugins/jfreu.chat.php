...
function event_jfreu($aseco, $answer) {
	...
	if ($action >= -4200 && $action <= -4001) {
		$target = $player->playerlist[abs($action)-4001]['login'];
	...
	elseif ($action >= -4400 && $action <= -4201) {
		$target = $player->playerlist[abs($action)-4201]['login'];
	...
	elseif ($action >= -4600 && $action <= -4401) {
		$target = $player->playerlist[abs($action)-4401]['login'];
	...
	elseif ($action >= -4800 && $action <= -4601) {
		$target = $player->playerlist[abs($action)-4601]['login'];
	...
	elseif ($action >= -5000 && $action <= -4801) {
		$target = $player->playerlist[abs($action)-4801]['login'];
	...
	elseif ($action >= -5200 && $action <= -5001) {
		$target = $player->playerlist[abs($action)-5001]['login'];
	...
	elseif ($action >= -5400 && $action <= -5201) {
		$target = $player->playerlist[abs($action)-5201]['login'];
	...
	elseif ($action >= -5600 && $action <= -5401) {
		$target = $player->playerlist[abs($action)-5401]['login'];
	...
	elseif ($action >= -5800 && $action <= -5601) {
		$target = $player->playerlist[abs($action)-5601]['login'];
	...
	elseif ($action >= -6000 && $action <= -5801) {
		$target = $player->playerlist[abs($action)-5801]['login'];
