 ...
 */
	...
	$message1 = 'Information about and download of this XASECO2 on ' . XASECO_TM2;
	...
	$message9 = 'Use "/list norank" to find maps you aren\'t ranked on, then /jukebox them!';
	...
	$message12 = 'Wondering which maps you haven\'t played recently?  Use "/list norecent" to find out!';
	...
	$message18 = 'Wondering what maps were played recently?  Use the "/history" command.';
	$message19 = 'Looking for the next better ranked record to beat?  Use "/nextrec"!';
	$message20 = 'Find the difference between your personal best and the map record with the "/diffrec" command!';
	...
	$message24 = 'Jukeboxed the wrong map?  Use "/jukebox drop" to remove it!';
	...
	$message28 = 'Use "/list newest <#>" to find the newest maps added to the server, then /jukebox them!';
	$message29 = 'Find the longest and shortest maps with the "/list longest / shortest" commands!';
	...
	$message33 = 'Find the MX info & records for a map with the "/mxinfo" & "/mxrecs" commands!';
	$message34 = 'Looking for the name of the current map\'s song?  Use the "/song" command!';
	$message35 = 'Looking for the name of the current map\'s mod?  Use the "/mod" command!';
	$message36 = 'Use the "/style" command to select your personal window style!';
	$message37 = 'Use the "/recpanel" command to select your personal records panel!';
	$message38 = 'Use the "/votepanel" command to select your personal vote panel!';
	$message39 = 'Find out all about the Dedimania world records system with "/helpdedi"!';
	$message40 =  'Check out the XASECO[2] site at ' . XASECO_ORG . ' !';
	global $feature_votes;
	if ($feature_votes) {
	$message41 = 'Find out all about the chat-based voting commands with "/helpvote"!';
	}
	if (function_exists('send_window_message')) {
	$message42 = 'Missed a system message?  Use "/msglog" to check the message history!';
	}
